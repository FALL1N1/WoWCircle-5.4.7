...
static PlayerAbilityStruct PlayerAbility[][3] =
{
    ...
    // 10 monk
    {{SPELL_MK_HEX_SPHERE, ABILITY_TARGET_ENEMY, 5000},
    {SPELL_MK_RENEWING_MIST, ABILITY_TARGET_SELF, 15000},
    {SPELL_MK_RISING_SUN_KICK, ABILITY_TARGET_ENEMY, 15000}},
    // 11 druid
                     ...
                     switch (eventId)
                     {
                        ...
                        case EVENT_SIPHON_SOUL:
                            if (Unit* pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0.0f, true))
                            {
                                ...
                                if (PlayerClass == CLASS_PRIEST-1 && pTarget->HasSpell(15473))
