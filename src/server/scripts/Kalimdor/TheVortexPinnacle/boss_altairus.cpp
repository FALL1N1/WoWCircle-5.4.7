    ...
    public:
        ...
        struct boss_altairusAI : public BossAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                Creature* airCurrent = ObjectAccessor::GetCreature(*me, _aircurrent);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_CALL_OF_WIND:
                             airCurrent = me->SummonCreature(NPC_AIR_CURRENT,
                                me->GetPositionX(),
                                me->GetPositionY(),
                                me->GetPositionZ(),
