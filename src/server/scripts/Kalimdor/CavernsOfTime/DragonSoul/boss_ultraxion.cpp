    ...
    public:
        ...
        struct boss_ultraxionAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                DespawnGameObjectsInArea(GO_GIFT_OF_LIFE, me);
                DespawnGameObjectsInArea(GO_ESSENCE_OF_DREAMS, me);
                DespawnGameObjectsInArea(GO_SOURCE_OF_MAGIC, me);
