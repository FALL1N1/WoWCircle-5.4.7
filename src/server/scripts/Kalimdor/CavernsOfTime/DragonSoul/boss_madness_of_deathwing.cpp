        ...
        struct boss_madness_of_deathwingAI : public BossAI
        {
            ...
            void SpellHit(Unit* /*who*/, const SpellInfo* spellInfo)
            {
                ...
                else if (spellInfo->Id == SPELL_FIRE_DRAGON_SOUL_SCRIPT)
                {
                    ...
                    DespawnCreaturesInArea(NPC_ALEXSTRASZA_DRAGON, me);
                    DespawnCreaturesInArea(NPC_KALECGOS_DRAGON, me);
                    DespawnCreaturesInArea(NPC_YSERA_DRAGON, me);
                    DespawnCreaturesInArea(NPC_NOZDORMU_DRAGON, me);
                    DespawnCreaturesInArea(NPC_THRALL_2, me);
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_THRALL_TALK_2:
                            ...
                            if (Creature* pThrall = me->FindNearestCreature(NPC_THRALL_2, 200.0f))
    ...
    public:
        ...
        struct npc_dragon_soul_thrall_1AI : public ScriptedAI
        {
            ...
            void ResetBattle(bool done = false)
            {
                if (!done)
                {
                    ...
                    DespawnCreaturesInArea(NPC_DEATHWING, me);
                    DespawnCreaturesInArea(NPC_DEATHWING_1, me);
                    DespawnCreaturesInArea(NPC_WING_TENTACLE, me);
                    DespawnCreaturesInArea(NPC_ARM_TENTACLE_1, me);
                    DespawnCreaturesInArea(NPC_ARM_TENTACLE_2, me);
                    DespawnCreaturesInArea(NPC_MUTATED_CORRUPTION, me);
                    DespawnCreaturesInArea(NPC_BLISTERING_TENTACLE, me);
                    DespawnCreaturesInArea(NPC_REGENERAIVE_BLOOD, me);
                    DespawnCreaturesInArea(NPC_ELEMENTIUM_BOLT, me);
                    DespawnCreaturesInArea(NPC_TIME_ZONE, me);
                    DespawnCreaturesInArea(NPC_IMPALING_TENTACLE, me);
                    DespawnCreaturesInArea(NPC_ELEMENTIUM_TERROR, me);
                    DespawnCreaturesInArea(NPC_CONGEALING_BLOOD, me);
        ...
        private:
            ...
            void DespawnCreatures(uint32 entry)
            {
                ...
                GetCreatureListWithEntryInGrid(creatures, me, entry, 1000.0f); // TODO: adjuste searche range
