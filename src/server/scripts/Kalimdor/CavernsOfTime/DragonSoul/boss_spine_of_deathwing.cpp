                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SUMMON_CORRUPTED_BLOOD:
                        {
                            ...
                            me->GetCreatureListWithEntryInGrid(targets, NPC_SPAWNER, 200.0f); // TODO: adjuste searche range
                            uint32 num = 0;
                            if (!targets.empty())
                            {
                                num = targets.size();
        ...
        private:
            ...
            void DoRoll(uint8 side /* 1 - left, 2 - right*/)
            {
                ...
                */
                ...
                DespawnCreaturesInArea(NPC_HIDEOUS_AMALGAMATION, me);
            ...
            {
                DespawnCreaturesInArea(NPC_HIDEOUS_AMALGAMATION, me);
                DespawnCreaturesInArea(NPC_CORRUPTION_1, me);
                DespawnCreaturesInArea(NPC_CORRUPTION_2, me);
                DespawnCreaturesInArea(NPC_CORRUPTION_3, me);
                DespawnCreaturesInArea(NPC_SPAWNER, me);
                DespawnCreaturesInArea(NPC_CORRUPTED_BLOOD, me);
                DespawnCreaturesInArea(NPC_BURNING_TENDONS_1, me);
                DespawnCreaturesInArea(NPC_BURNING_TENDONS_2, me);
