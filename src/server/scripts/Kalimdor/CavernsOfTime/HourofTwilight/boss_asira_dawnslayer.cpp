                    ...
                    bool operator()(WorldObject* unit)
                    {
                        ...
                        switch (unit->ToPlayer()->getClass())
                        {
                            ...
                            case CLASS_HUNTER:
                                return true;
                            case CLASS_DRUID:
                                if (unit->ToPlayer()->GetSpecializationId(unit->ToPlayer()->GetActiveSpec()) == SPEC_DRUID_BEAR ||
                                    unit->ToPlayer()->GetSpecializationId(unit->ToPlayer()->GetActiveSpec()) == SPEC_DRUID_CAT)
                                    return true;
                                return false;
                            case CLASS_PALADIN:
                                if (unit->ToPlayer()->GetSpecializationId(unit->ToPlayer()->GetActiveSpec()) == SPEC_PALADIN_HOLY)
                                    return false;
                                return true;
                            default:
                                return false;
