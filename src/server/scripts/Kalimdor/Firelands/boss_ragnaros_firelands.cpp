    ...
    public:
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_CONTINUE_PHASE_2:
                            ...
                            DespawnCreaturesInArea(NPC_SULFURAS_HAND_OF_RAGNAROS_1, me);
                            DespawnCreaturesInArea(NPC_SULFURAS_HAND_OF_RAGNAROS_2, me);
        ...
        private:
            ...
            void DespawnEncounterCreatures()
            {
                DespawnCreaturesInArea(NPC_SULFURAS_HAND_OF_RAGNAROS_1, me);
                DespawnCreaturesInArea(NPC_SULFURAS_HAND_OF_RAGNAROS_2, me);
                DespawnCreaturesInArea(NPC_MOLTEN_ELEMENTAL, me);
                DespawnCreaturesInArea(NPC_LAVA_WAVE, me);
                DespawnCreaturesInArea(NPC_BLAZING_HEAT, me);
                DespawnCreaturesInArea(NPC_DREADFLAME, me);
                DespawnCreaturesInArea(NPC_BREADTH_OF_FROST, me);
                DespawnCreaturesInArea(NPC_CLOUDBURST, me);
                DespawnCreaturesInArea(NPC_ENTRAPPING_ROOTS, me); 
            }

            void DespawnEventCreatures()
            {
                DespawnCreaturesInArea(NPC_CENARIUS, me);
                DespawnCreaturesInArea(NPC_HAMUUL_RUNETOTEM, me);
                DespawnCreaturesInArea(NPC_MALFURION_STORMRAGE, me);
            }
...
class npc_ragnaros_firelands_molten_elemental : public CreatureScript
{
    public:
        ...
        struct npc_ragnaros_firelands_molten_elementalAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* /*who*/)
            {
                if (Creature* pCaster = me->FindNearestCreature(NPC_MOLTEN_SEED_CASTER, 200.0f))
                ...
                if (uint32 eventId = events.ExecuteEvent()) 
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_BLAZING_HEAT:
                        {
                            ...
                            GetCreatureListWithEntryInGrid(lavascions, me, NPC_LAVA_SCION, 200.0f);
