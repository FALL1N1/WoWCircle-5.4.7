...
class boss_alysrazor : public CreatureScript
{
    public:
        ...
        struct boss_alysrazorAI : public BossAI
        {
            ...
            { 
                _Reset();
                DespawnGameObjectsInArea(GO_MOLTEN_METEOR, me);
                DespawnCreaturesInArea(NPC_MOLTEN_METEOR_2, me);
                me->SetCanFly(false);
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                else if (phase == 4 && me->GetPower(POWER_MANA) >= 100)
                {
                    ...
                    me->GetCreatureListWithEntryInGrid(creatureList, NPC_DULL_PYRESHELL_FOCUS, 300.0f); // TODO: adjuste searche range
