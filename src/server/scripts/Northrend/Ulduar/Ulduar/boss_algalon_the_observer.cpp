...
class ActivateLivingConstellation : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 execTime, uint32 /*diff*/)
        {
            ...
            _owner->CastSpell((Unit*)NULL, SPELL_TRIGGER_3_ADDS, true);
...
class CosmicSmashDamageEvent : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 /*execTime*/, uint32 /*diff*/)
        {
            _caster->CastSpell((Unit*)NULL, SPELL_COSMIC_SMASH_TRIGGERED, true);
            return true;
        }
...
class SummonUnleashedDarkMatter : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 execTime, uint32 /*diff*/)
        {
            _caster->CastSpell((Unit*)NULL, SPELL_SUMMON_UNLEASHED_DARK_MATTER, true);
    ...
    public:
        ...
        struct boss_algalon_the_observerAI : public BossAI
        {
            ...
            void EnterCombat(Unit* /*target*/)
            {
                ...
                me->GetCreatureListWithEntryInGrid(stalkers, NPC_ALGALON_STALKER, 200.0f); // TODO: adjuste searche range
            ...
            void JustSummoned(Creature* summon)
            {
                ...
                switch (summon->GetEntry())
                {
                    ...
                    case NPC_COLLAPSING_STAR:
                        ...
                        summon->CastSpell(summon, SPELL_COLLAPSE, true);
                        break;
                    case NPC_BLACK_HOLE:
                        summon->SetReactState(REACT_PASSIVE);
                    ...
                    case NPC_WORM_HOLE:
                        summon->SetReactState(REACT_PASSIVE);
                        summon->CastSpell(summon, SPELL_WORM_HOLE_TRIGGER, true);
                        summon->CastSpell(summon, SPELL_SUMMON_VOID_ZONE_VISUAL, true);
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_BIG_BANG:
                        {
                            ...
                            me->GetCreatureListWithEntryInGrid(constellations, NPC_LIVING_CONSTELLATION, 200.0f); // TODO: adjuste searche range
    ...
    public:
        ...
        struct npc_living_constellationAI : public CreatureAI
        {
            ...
            void SpellHit(Unit* caster, SpellInfo const* spell)
            {
                ...
                caster->CastSpell((Unit*)NULL, SPELL_BLACK_HOLE_CREDIT, true);
    ...
    public:
        ...
        class spell_algalon_phase_punch_AuraScript : public AuraScript
        {
            ...
            void HandlePeriodic(AuraEffect const* /*aurEff*/)
            {
                ...
                GetTarget()->CastSpell(GetTarget(), PhasePunchAlphaId[GetStackAmount() - 1], true);
                if (GetStackAmount() == 5)
