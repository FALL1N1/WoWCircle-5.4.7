                        ...
                        case EVENT_CHECK_WIPE:
                            {
                                ...
                                else
                                {
                                    ...
                                    me->GetCreatureListWithEntryInGrid(addList, NPC_THORIM, 200.0f); // TODO: adjuste searche range
                                    me->GetCreatureListWithEntryInGrid(addList, NPC_IRON_RING_GUARD, 200.0f); // TODO: adjuste searche range
                                    me->GetCreatureListWithEntryInGrid(addList, NPC_DARK_RUNE_ACOLYTE_TUNNEL, 200.0f); // TODO: adjuste searche range
                                    me->GetCreatureListWithEntryInGrid(addList, NPC_IRON_HONOR_GUARD, 200.0f); // TODO: adjuste searche range
