    ...
    public:
        ...
        struct boss_freyaAI : public BossAI
        {
            ...
            void EncounterPostProgress()
            {
                ...
                if (summonSpell.find(me->GetMap()->GetDifficulty()) != summonSpell.end() && _elderCount < 4)
                    l_SpellId = summonSpell[me->GetMap()->GetDifficulty()][_elderCount];
