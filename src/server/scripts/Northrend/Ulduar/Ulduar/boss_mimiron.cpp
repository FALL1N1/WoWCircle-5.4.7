...
struct EqualHelper // Helper for Mimirons map that stores the members repair states
{
    ...
    void operator()(std::pair<uint32, bool> const& value)
    {
    ...
    public:
        ...
        struct boss_mimironAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                DespawnCreaturesInArea(NPC_FLAMES_INITIAL, me);
                DespawnCreaturesInArea(NPC_PROXIMITY_MINE, me);
                DespawnCreaturesInArea(NPC_ROCKET, me);
                DespawnCreaturesInArea(NPC_JUNK_BOT, me);
                DespawnCreaturesInArea(NPC_ASSAULT_BOT, me);
                DespawnCreaturesInArea(NPC_BOOM_BOT, me);
                DespawnCreaturesInArea(NPC_EMERGENCY_BOT, me);
