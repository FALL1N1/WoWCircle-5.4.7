        ...
        void HandleSendEvent(SpellEffIndex effIndex)
        {
            ...
            if (Unit* caster = GetCaster())
            {
                if (Creature* presence = caster->FindNearestCreature(NPC_PRESENCE, 50.0f))
                {
                    ...
                    GetCaster()->GetCreatureListWithEntryInGrid(servants, NPC_SERVANT, 200.0f); // TODO: adjuste searche range
                    ...
                    caster->GetCreatureListWithEntryInGrid(saboteurs, NPC_SABOTEUR, 200.0f); // TODO: adjuste searche range
