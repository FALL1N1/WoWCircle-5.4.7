                    ...
                    case ACTION_SPIRIT_KILLED:
                    {
                        ...
                        if (nextSpirit >= 4)
                        {
                            ...
                            if (pInstance)
                            {
                                ...
                                if (IsHeroic())
                                    pInstance->DoCompleteAchievement(ACHIEVEMENT_HEROIC_FOUR_KINGS);
                            ...
                            GetCreatureListWithEntryInGrid(shadList, me, NPC_UNDYING_SHADOW, 300.0f); // TODO: adjuste searche range
...
{
    new boss_spirit_kings_controler();  ///< 60984
    new boss_spirit_kings();            ///< 60701 - 60708 - 60709 - 60710
    new mob_pinning_arrow();            ///< 60958
    new mob_undying_shadow();           ///< 60731
    new spell_massive_attacks();        ///< 117921
    new spell_volley();                 ///< 118094 - 118105 - 118106
    new spell_pinned_down();            ///< 118145
    new spell_maddening_shout();        ///< 117708
    new spell_crazed_cowardice();       ///< 117756 - 117737
    new spell_crazy_thought();          ///< 117833
    new spell_coalescing_shadow();      ///< 117558
    new spell_sleight_of_hand();        ///< 118162
    new spell_shield_of_darkness();     ///< 117697
}
