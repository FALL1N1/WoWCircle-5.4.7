    ...
    public:
        ...
        struct boss_jin_qin_xiAI : public BossAI
        {
            ...
            void JustDied(Unit* killer)
            {
                ...
                pInstance->DoCompleteAchievement(IsHeroic() ? ACHIEVEMENT_HEROIC_WILL_OF_EMPEROR : ACHIEVEMENT_VAULT_OF_MYSTERIES);
            }
            ...
            void DoAction(const int32 action)
            {
                switch (action)
                {
                    ...
                    case ACTION_REACHHOME:
                    {
                        ...
                        GetCreatureListWithEntryInGrid(bunnyList, me, NPC_GENERAL_PURPOSE_BUNNY_JMF, 300.0f); // TODO: adjuste searche range
                ...
                switch(events.ExecuteEvent())
                {
                    ...
                    case EVENT_DEVASTATING_COMBO:
                    {
                        ...
                        else
                        {
                            ...
                            aliveList.clear();
                            GetPlayerListInGrid(plyrList, me, 300.0f); // TODO: adjuste searche range
...
class mob_general_purpose_bunnyJMF : public CreatureScript
{
    public:
        ...
        struct mob_general_purpose_bunnyJMFAI : public ScriptedAI
        {
            ...
            void DamageTaken(Unit* /*p_Attacker*/, uint32& p_Damages)
            {
                p_Damages = 0;
            }
...
{
    new boss_jin_qin_xi();                  ///< 60399 - 60400
    new mob_woe_add_generic();              ///< 60396 - 60397 - 60398
    new mob_woe_titan_spark();              ///< 60480
    new mob_general_purpose_bunnyJMF();     ///< 60648
    new mob_ancient_mogu_machine();         ///< 55091
    new spell_cosmetic_lightning();         ///< 127732
    new spell_terracota_spawn();            ///< 118165
    new spell_devastating_arc();            ///< 116818
    new spell_arc_visual();                 ///< 117195
    new spell_impeding_thrust();            ///< 116968
    new spell_magnetized_jan();             ///< 117006
    new spell_magnetized_qin();             ///< 117485
    new spell_titan_gas();                  ///< 116803
    new spell_titan_gas2();                 ///< 118327
    new spell_energizing_smash();           ///< 116550
    new spell_energizing_visual();          ///< 116556
    new spell_energized();                  ///< 116605
    new go_ancien_control_console();        ///< 211584
    new achievement_show_me_you_moves();    ///< 6455 (crit. id 19105)
}
