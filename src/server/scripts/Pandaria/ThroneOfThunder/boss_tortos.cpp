    ...
    public:
        ...
        struct boss_tortosAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                me->SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, 48.0f);
                me->SetFloatValue(UNIT_FIELD_COMBATREACH, 48.0f);
    ...
    public:
        ...
        struct npc_tortos_whirl_turtleAI : public ScriptedAI
        {
            ...
            void Reset()
            {
                ...
                me->SetSpeed(MOVE_WALK, 2.f, true);
                me->SetSpeed(MOVE_RUN, 2.f, true);
            ...
            void DoAction(const int32 action)
            {
                if (action == ACTION_TURTLE_KICKED)
                {
                    ...
                    {
                        if (Creature* pTortos = pInstance->instance->GetCreature(pInstance->GetData64(DATA_TORTOS)))
                        {
    ...
    public:
        ...
        class spell_tortos_shell_concussion_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                BeforeHit += SpellHitFn(spell_tortos_shell_concussion_SpellScript::HandleBeforeHit);
            }
        };
...
class spell_tortos_crystal_shell_damage_absorption: public SpellScriptLoader
{
    public:
        ...
        class spell_tortos_crystal_shell_damage_absorption_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_tortos_crystal_shell_damage_absorption_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB);
...
class spell_tortos_crystal_shell_heal_absorption: public SpellScriptLoader
{
    public:
        spell_tortos_crystal_shell_heal_absorption() : SpellScriptLoader("spell_tortos_crystal_shell_heal_absorption") { }

        class spell_tortos_crystal_shell_heal_absorption_AuraScript : public AuraScript
        {
            PrepareAuraScript(spell_tortos_crystal_shell_heal_absorption_AuraScript);
            ...
            void Register()
            {
                DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_tortos_crystal_shell_heal_absorption_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_SCHOOL_HEAL_ABSORB);
                OnEffectAbsorb += AuraEffectAbsorbFn(spell_tortos_crystal_shell_heal_absorption_AuraScript::OnAbsorb, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB);
            }
        };

        AuraScript* GetAuraScript() const
        {
            return new spell_tortos_crystal_shell_heal_absorption_AuraScript();
        }
};
...
void AddSC_boss_tortos()
{
    ...
    new spell_tortos_crystal_shell_heal_absorption();
