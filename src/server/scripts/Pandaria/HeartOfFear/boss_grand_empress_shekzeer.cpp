        ...
        struct boss_shekzeerAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/)
            {
                ...
                for (uint32 mob : amberEntries)
                {
                    ...
                    GetCreatureListWithEntryInGrid(addList, me, mob, 200.0f); // TODO: adjuste searche range
                ...
                if (pInstance)
                {
                    ...
                    pInstance->DoCompleteAchievement(IsHeroic() ? ACHIEVEMENT_HEROIC_SHEKZEER : ACHIEVEMENT_NIGHTMARE_OF_SHEKZEER);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_CORRUPT_FIELD:
                        {
                            ...
                            GetCreatureListWithEntryInGrid(fieldList, me, NPC_DISSONANCE_FIELD, 200.0f); // TODO: adjuste searche range
    ...
    public:
        ...
        struct mob_amber_trapAI : public ScriptedAI
        {
            ...
            void Reset()
            {
                ...
                {
                    addList.clear();
                    GetCreatureListWithEntryInGrid(addList, me, NPC_SETTHIK_WINDBLADE, 200.0f); // TODO: adjuste searche range
