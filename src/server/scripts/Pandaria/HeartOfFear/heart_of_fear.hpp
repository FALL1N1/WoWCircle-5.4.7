...
#ifndef HEART_OF_FEAR_HPP
#define HEART_OF_FEAR_HPP
...
{
    // Wings
    ACHIEVEMENT_THE_DREAD_APPROACH        = 6718, // Killing the 3 first boss
    ACHIEVEMENT_NIGHTMARE_OF_SHEKZEER     = 6845, // Killing the 3 last boss
    // Heroic mode
    ACHIEVEMENT_HEROIC_ZORLOK             = 6725,
    ACHIEVEMENT_HEROIC_TAYAK              = 6726,
    ACHIEVEMENT_HEROIC_GARALON            = 6727,
    ACHIEVEMENT_HEROIC_MELJARAK           = 6728,
    ACHIEVEMENT_HEROIC_UNSOK              = 6729,
    ACHIEVEMENT_HEROIC_SHEKZEER           = 6730,
    // Specific Achievements
    ACHIEVEMENT_LESS_THAN_THREE           = 6683, // Mel'jarak: Kill boss without CC more than 2 adds at the same time
    ACHIEVEMENT_LIKE_AN_ARROW_TO_THE_FACE = 6553, // Garalon: Kill boss without destroying any leg
    // @Todo
    ACHIEVEMENT_CANDLE_IN_THE_WIND        = 6936, // Ta'yak: Kill boss while all 4 braziers are lit
    ACHIEVEMENT_HEARD_YOU_LIKE_AMBER      = 6518, // Un'sok: Kill Living Amber in Burning Amber until 8 pools overlap and kill boss
    ACHIEVEMENT_TIMING_IS_EVERYTHING      = 6922  // Shek'zeer: Kill 2 Kor'thik Reavers within 10 seconds of each other, and kill boss
};

#define DISPLAYID_INVISIBLE 11686

#endif // HEART_OF_FEAR_HPP
