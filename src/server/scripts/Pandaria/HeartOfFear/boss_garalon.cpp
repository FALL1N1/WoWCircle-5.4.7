...
public:
    ...
    struct boss_garalonAI : public BossAI
    {
        ...
        void ResetLegs()
        {
            ...
            GetCreatureListWithEntryInGrid(legList, me, NPC_GARALON_LEG, 200.0f); // TODO: adjuste searche range
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            if (instance)
            {
                ...
                instance->DoCompleteAchievement(IsHeroic() ? ACHIEVEMENT_HEROIC_GARALON : ACHIEVEMENT_THE_DREAD_APPROACH);

                if (achievementNoDeadLeg)
                    instance->DoCompleteAchievement(ACHIEVEMENT_LIKE_AN_ARROW_TO_THE_FACE);
        ...
        void DoAction(int32 const action)
        {
            switch (action)
            {
                ...
                case ACTION_GARALON_VISIBLE:
                {
                    ...
                    GetCreatureListWithEntryInGrid(l_LegList, me, NPC_GARALON_LEG, 200.0f); // TODO: adjuste searche range
        ...
        class spell_garalon_mend_legSpellScript: public SpellScript
        {
            ...
            {/*
                ...
                if (Unit* Garalon = GetCaster())
                {
                    ...
                    uint64 legHighGuid = MAKE_NEW_GUID(legLowGuid, NPC_GARALON_LEG, HighGuid::Unit);
                    if (Unit* leg = ObjectAccessor::GetUnit(*Garalon, legHighGuid))
            ...
            void HandleScriptEffect(SpellEffIndex effIndex)
            {
                ...
                {
                    if (Creature* leg = garalon->GetMap()->GetCreature(MAKE_NEW_GUID(garalon->AI()->GetData(ACTION_LEG_IS_DEAD), NPC_GARALON_LEG, HighGuid::Unit)))
