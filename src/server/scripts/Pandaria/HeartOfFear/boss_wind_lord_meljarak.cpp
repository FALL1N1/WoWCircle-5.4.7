...
public:
    ...
    struct boss_wind_lord_meljarakAI : public BossAI
    {
        ...
        void Reset()
        {
            ...
            {
                std::list<Creature*> addList;
                GetCreatureListWithEntryInGrid(addList, me, addEntries[i], 300.0f); // TODO: adjuste searche range
        ...
        void EnterCombat(Unit* attacker)
        {
            ...
            GetGameObjectListWithEntryInGrid(l_DoorList, me, GOB_DOOR_TO_MELJARAK, 500.0f); // TODO: adjuste searche range
        ...
        void EnterEvadeMode()
        {
            ...
            GetGameObjectListWithEntryInGrid(rackList, me, GOB_WEAPON_RACK, 200.0f); // TODO: adjuste searche range
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            if (instance)
            {
                ...
                if (IsHeroic())
                    instance->DoCompleteAchievement(ACHIEVEMENT_HEROIC_MELJARAK);

                if (achieveLessThanThree)
                    instance->DoCompleteAchievement(ACHIEVEMENT_LESS_THAN_THREE);
            ...
            std::list<GameObject*> l_DoorList;
            GetGameObjectListWithEntryInGrid(l_DoorList, me, GOB_DOOR_TO_MELJARAK, 100.0f);
    ...
    struct npc_korthik_elite_blademasterAI: public ScriptedAI
    {
        ...
        void JustDied(Unit* killer)
        {
            if (respawn)
            {
                ...
                GetCreatureListWithEntryInGrid(mobList, me, me->GetEntry(), 200.0f); // TODO: adjuste searche range
    ...
    struct npc_amber_prison_meljarakAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 const diff)
        {
            if (timerChecktarget <= diff)
            {
                ...
                if (Unit* l_Target = Unit::GetUnit(*me, m_TargetGuid))
                {
                    if (l_Target->HasAura(SPELL_AMBER_PRISON_AURA))
