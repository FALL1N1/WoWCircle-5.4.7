    ...
    public:
        ...
        struct boss_sha_of_fearAI : public BossAI
        {
            ...
            void EnterEvadeMode()
            {
                ...
                if (!pInstance->IsWipe() || pInstance->GetBossState(DATA_SHA_OF_FEAR) == FAIL)
                    return;
            ...
            void JustDied(Unit* killer)
            {
                ...
                if (pInstance)
                {
                    ...
                    if (!isInSecondPhase)
                    {
                        ...
                        GetCreatureListWithEntryInGrid(returnMobList, me, NPC_RETURN_TO_THE_TERRACE, 300.0f); // TODO: adjuste searche range
                    ...
                    pInstance->DoCompleteAchievement(IsHeroic() ? ACHIEVEMENT_HEROIC_SHA_OF_FEAR : ACHIEVEMENT_TERRACE);
...
class mob_terror_spawn : public CreatureScript
{
    public:
        ...
        struct mob_terror_spawnAI : public ScriptedAI
        {
            ...
            void Reset()
            {
                if (pInstance)
                {
                    if (Creature* pureLight = Creature::GetCreature(*me, pInstance->GetData64(NPC_PURE_LIGHT_TERRACE)))
                    {
                        ...
                        me->SetOrientation(me->GetAngle(pureLight));
                    }
                }
            ...
            void CheckHitResult(MeleeHitOutcome& p_MeleeHitResult, SpellMissInfo& p_SpellResult, Unit* p_Attaker, SpellInfo const* const p_SpellInfo)
            {
    ...
    public:
        ...
        class spell_sha_waterspout_SpellScript : public SpellScript
        {
            ...
            void Damage()
            {
                ...
                std::list<Player*> playerList;
                GetPlayerListInGrid(playerList, caster, 500.0f); // TODO: adjuste searche range
    ...
    public:
        ...
        class spell_transfer_light_SpellScript : public SpellScript
        {
            ...
            void Transfer()
            {
                ...
                GetCreatureListWithEntryInGrid(dreadList, caster, NPC_DREAD_SPAWN, 300.0f); // TODO: adjuste searche range
