                    ...
                    if (corruptionBoltTimer)
                    {
                        if (corruptionBoltTimer <= diff)
                        {
                            ...
                            if (pInstance)
                            {
                                ...
                                if (Unit* target = sObjectAccessor->GetUnit(*me, (*targets.begin())))
...
{
    new npc_springtender_ashani();      ///< 64846
    new npc_apparition_of_fear();       ///< 64368
    new npc_apparition_of_terror();     ///< 66100
    new mob_night_terrors();            ///< 64390
    new mob_night_terror_summon();      ///< 64393
    new spell_night_terrors_missile();  ///< 125736
    new spell_night_terrors_periodic(); ///< 125745
}
