    ...
    public:
        ...
        struct boss_lei_shiAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                me->SetDisplayId(eLeiShiModels::EvilDisplay);
            ...
            void EnterEvadeMode()
            {
                if (!pInstance || pInstance->GetBossState(DATA_LEI_SHI) != IN_PROGRESS)
                    return;
            ...
            void DamageTaken(Unit* attacker, uint32& damage)
            {
                ...
                if (me->HealthBelowPctDamaged(endCombatPct, damage))
                {
                    ...
                    if (pInstance)
                    {
                        ...
                        if (IsHeroic())
                            pInstance->DoCompleteAchievement(ACHIEVEMENT_HEROIC_LEI_SHI);
            ...
            void FreeLeiShi()
            {
                ...
                me->RemoveAllAreasTrigger();
                me->RemoveAllAuras();
                me->SetDisplayId(eLeiShiModels::GoodDisplay);
                me->SetFullHealth();
        ...
        private:
            ...
            {
                instance->UpdateEncounterState(ENCOUNTER_CREDIT_CAST_SPELL, SPELL_LEI_SHI, me);
                instance->DoUpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET, SPELL_LEI_SHI, 0, 0, me);
            }
        };
        ...
        class spell_hide_AuraScript : public AuraScript
        {
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                if (Unit* caster = GetCaster())
                {
                    ...
                    caster->SetDisplayId(eLeiShiModels::EvilDisplay);
                }
            }
...
/// Spell 123461
class at_get_away : public MS::AreaTriggerEntityScript
{
    public:
        at_get_away() : MS::AreaTriggerEntityScript("at_get_away") { }
        ...
        void OnUpdate(AreaTrigger* p_AreaTrigger, uint32 p_Time) override
        {
            ...
            p_AreaTrigger->GetPlayerListInGrid(l_PlayerList, 60.0f);
            ...
            {
                if (l_Player->IsWithinDist(l_Caster, 40.0f, false))
                {
                    if (l_Player->isAlive() && !l_Player->GetForcedMovement().IsActive())
                        l_Player->GetForcedMovement().StartPushingFrom(l_Pos, 3.0f);
        ...
        {
            std::list<Player*> l_PlayerList;
            p_AreaTrigger->GetPlayerListInGrid(l_PlayerList, 100.0f);
