...
extern std::map<uint32, CriteriaEntry const*>    sCriteriaMap;
...
extern std::map<uint32, std::vector<ModifierTreeEntry const*> > sModifierTreeMap;
extern std::map<uint32, std::vector<CriteriaTreeEntry const*> > sCriteriaTreeMap;
extern std::map<uint32, std::vector<CriteriaTreeEntry const*> > sLinkedCriteriaTreeMap;
extern std::map<uint32 /*criteriaId*/, AchievementEntry const*> sCriteriaAchievementMap;
extern std::map<uint32 /*old criteriaId*/, uint32 /*criteriaTreeId*/> sOldCriteriaToNewMap;
