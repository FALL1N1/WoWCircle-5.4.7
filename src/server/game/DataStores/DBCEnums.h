...
enum AchievementCriteriaAdditionalCondition
{
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_PLAYER_CONDITION            = 2,
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_UNKNOWN                     = 20,
    ...
    ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_MAP_DIFFICULTY              = 68,
    // 70 - ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_TARGET_MIN_LEVEL
    // 78 - battle pet family
    // 79 - battle pet max % health
...
{
    ACHIEVEMENT_TIMED_TYPE_SPELL_CASTER     = 7,    // Timer is started by casting a spell with entry in StartEvent
    ACHIEVEMENT_TIMED_TYPE_SPELL_TARGET     = 8,    // Timer is started by being target of spell with entry in StartEvent
    ACHIEVEMENT_TIMED_TYPE_QUEST            = 9,    // Timer is started by accepting quest with entry in StartEvent
    ACHIEVEMENT_TIMED_TYPE_CREATURE         = 10,    // Timer is started by killing creature with entry in StartEvent
    ACHIEVEMENT_TIMED_TYPE_ITEM             = 12,    // Timer is started by using item with entry in StartEvent
    ACHIEVEMENT_TIMED_TYPE_EVENT            = 13,    // Timer is started by internal event with id in StartEvent

    ACHIEVEMENT_TIMED_TYPE_MAX = 15,
};
...
#define MAX_DUNGEON_DIFFICULTY     CHALLENGE_MODE_DIFFICULTY+1
