...
class OPvPCapturePoint
{
    ...
    protected:
        ...
        std::map<uint32, uint32> m_Creatures;
        std::map<uint32, uint32> m_ObjectTypes;
        std::map<uint32, uint32> m_CreatureTypes;
};
...
class OutdoorPvP : public ZoneScript
{
    ...
    public:
        ...
        typedef std::pair<uint32, GameObject*> GoScriptPair;
        typedef std::pair<uint32, Creature*> CreatureScriptPair;
    ...
    protected:
        ...
        std::map<uint32, GameObject*> m_GoScriptStore;
        std::map<uint32, Creature*> m_CreatureScriptStore;
