...
enum IROpcodes
{
    ...
    IR_CMSG_CHARACTER_QUESTS                        = 0x74,

    IR_CMSG_GUILD                                   = 0x6E,
    IR_SMSG_GUILD_QUERY                             = 0x6F,

    IR_SMSG_SYNC_PLAYER_CURRENCY                    = 0x70,
    IR_SMSG_SYNC_PLAYER_ACHIEVEMENTS                = 0x71,
    IR_SMSG_SYNC_PLAYER_REPUTATION                  = 0x72,
    IR_SMSG_SYNC_PLAYER_KILLS                       = 0x73,
    IR_SMSG_SYNC_PLAYER_QUESTS                      = 0x75,

    IR_SMSG_ANTICHEAT_REPORT_NOTIFICATION           = 0x90,

    IR_CMSG_BAN_INTERREALM_PLAYER                   = 0x91,
    IR_SMSG_BAN_INTERREALM_PLAYER_RESP              = 0x92,
