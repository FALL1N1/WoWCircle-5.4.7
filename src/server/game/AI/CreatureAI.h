...
class CreatureAI : public UnitAI
{
    ...
    public:
        ...
        virtual void SplineMovementUpdate(uint32 type, uint32 id) {}
        ...
        // Called when a creature has one of his power modified
        virtual void PowerModified(Powers p_Power, int32 p_Value) { }

        virtual bool CanRegeneratePower(Powers power) const { return true; };
