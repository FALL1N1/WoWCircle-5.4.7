...
class GameObject : public WorldObject, public GridObject<GameObject>, public MapObject
{
    public:
        ...
        uint8 GetGoAnimProgress() const { return GetByteValue(GAMEOBJECT_FIELD_ANIM_PROGRESS, 3); }
        ...
        void SendGameObjectActivateAnimKit(uint32 p_AnimKitID, bool p_Maintain = true);
