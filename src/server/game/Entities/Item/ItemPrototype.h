...
struct ItemTemplate
{
    ...
    bool IsConsumableAtInterRealm() const { 
        return Class == ITEM_CLASS_CONSUMABLE && 
            (SubClass == ITEM_SUBCLASS_POTION || 
            SubClass == ITEM_SUBCLASS_ELIXIR ||
            SubClass == ITEM_SUBCLASS_FLASK || 
            SubClass == ITEM_SUBCLASS_FOOD_DRINK); }
    ...
    uint32 GetBaseUpgradeId() const
    {
        ...
        return (*itr->second.begin())->UpgradeId;
    }
