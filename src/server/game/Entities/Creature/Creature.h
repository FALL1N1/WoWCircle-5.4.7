...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_DUMMY           = 0x00200000,       // Creature don't activate trap
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_VEHICLE_ATTACKABLE_PASSENGERS | CREATURE_FLAG_EXTRA_DUMMY)
...
class Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool IsImmunedToSpell(SpellInfo const* spellInfo, bool permanent = false);
                                                            // redefine Unit::IsImmunedToSpell
        bool IsImmunedToSpellEffect(SpellInfo const* spellInfo, uint32 index, bool permanent = false) const;
        ...
        void SetFixedAttackDistance(const float distance);
        float GetFixedAttackDistance() const;
        ...
        void DespawnCreaturesInArea(std::vector<uint32> entryList, float radius = 100.f);
        void DespawnCreaturesInArea(uint32 entry, float radius = 100.f);
        ...
        bool IsShouldKeepOrientationWhileCasting() const;
