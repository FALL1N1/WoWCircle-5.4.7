...
bool Vehicle::AddPassenger(Unit* unit, int8 seatId)
{
    ...
    unit->m_movementInfo.transport.pos.SetOrientation(0);
    ...
    {
        case 2824:
            unit->m_movementInfo.transport.pos.m_positionX = 0.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 0.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 0.0f;
            break;
        case 10882:
            unit->m_movementInfo.transport.pos.m_positionX = 15.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 0.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 30.0f;
            break;
        // Galleon
        case 11227: // 0 galleon
            unit->m_movementInfo.transport.pos.m_positionX = 0.4266f;
            unit->m_movementInfo.transport.pos.m_positionY = -10.8f;
            unit->m_movementInfo.transport.pos.m_positionZ = 34.4763f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        ...
        case 11229: // 2 galleon
            unit->m_movementInfo.transport.pos.m_positionX = 21.2562f;
            unit->m_movementInfo.transport.pos.m_positionY = -0.007199988f;
            unit->m_movementInfo.transport.pos.m_positionZ = 15.3918f;
            unit->m_movementInfo.transport.pos.SetOrientation(0);
            break;
        case 11233: // 4 galleon
            unit->m_movementInfo.transport.pos.m_positionX = -8.748f;
            unit->m_movementInfo.transport.pos.m_positionY = 0.4662f;
            unit->m_movementInfo.transport.pos.m_positionZ = 36.0963f;
            unit->m_movementInfo.transport.pos.SetOrientation(0);
            break;
        case 11234: // 5 galleon
            unit->m_movementInfo.transport.pos.m_positionX = -32.4513f;
            unit->m_movementInfo.transport.pos.m_positionY = 0.4752f;
            unit->m_movementInfo.transport.pos.m_positionZ = 28.7037f;
            unit->m_movementInfo.transport.pos.SetOrientation(0);
            break;
        // Galleon Skirmisher
        case 11230: // 3 galleon
            unit->m_movementInfo.transport.pos.m_positionX = 12.0654f;
            unit->m_movementInfo.transport.pos.m_positionY = -3.3f;
            unit->m_movementInfo.transport.pos.m_positionZ = 19.9944f;
            unit->m_movementInfo.transport.pos.SetOrientation(5.497787f);
            break;
        case 11235: // 6 galleon
            unit->m_movementInfo.transport.pos.m_positionX = 11.1654f;
            unit->m_movementInfo.transport.pos.m_positionY = 2.97f;
            unit->m_movementInfo.transport.pos.m_positionZ = 20.1744f;
            unit->m_movementInfo.transport.pos.SetOrientation(0.7853982f);
            break;
        case 11237: // 0 mid back
            unit->m_movementInfo.transport.pos.m_positionX = -9.0f;
            unit->m_movementInfo.transport.pos.m_positionY = -4.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = -9.7f;
            unit->m_movementInfo.transport.pos.SetOrientation(4.712389f);
            break;
        case 11238: // 1 mid back
            unit->m_movementInfo.transport.pos.m_positionX = -9.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 3.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = -9.7f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        case 11239: // 0 far back
            unit->m_movementInfo.transport.pos.m_positionX = -2.0f;
            unit->m_movementInfo.transport.pos.m_positionY = -4.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = -5.8f;
            unit->m_movementInfo.transport.pos.SetOrientation(4.712389f);
            break;
        case 11240: // 1 far back
            unit->m_movementInfo.transport.pos.m_positionX = -2.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 3.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = -6.0f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        case 11241: // 2 far back
            unit->m_movementInfo.transport.pos.m_positionX = 5.5f;
            unit->m_movementInfo.transport.pos.m_positionY = -4.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = -3.30f;
            unit->m_movementInfo.transport.pos.SetOrientation(4.712389f);
            break;
        case 11242: // 3 far back
            unit->m_movementInfo.transport.pos.m_positionX = 5.5f;
            unit->m_movementInfo.transport.pos.m_positionY = 3.2f;
            unit->m_movementInfo.transport.pos.m_positionZ = -3.3f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        // Galleon Warmonger
        case 11243: // 2 mid back
            unit->m_movementInfo.transport.pos.m_positionX = -5.0f;
            unit->m_movementInfo.transport.pos.m_positionY = -3.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 13.0f;
            unit->m_movementInfo.transport.pos.SetOrientation(4.712389f);
            break;
        case 11244: // 3 mid back
            unit->m_movementInfo.transport.pos.m_positionX = -5.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 2.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 12.8f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        case 11245: // 4 mid back
            unit->m_movementInfo.transport.pos.m_positionX = -13.0f;
            unit->m_movementInfo.transport.pos.m_positionY = -3.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 9.4f;
            unit->m_movementInfo.transport.pos.SetOrientation(4.712389f);
            break;
        case 11246: // 5 mid back
            unit->m_movementInfo.transport.pos.m_positionX = -13.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 1.5f;
            unit->m_movementInfo.transport.pos.m_positionZ = 9.5f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        case 11247: // 4 far back
            unit->m_movementInfo.transport.pos.m_positionX = 2.0f;
            unit->m_movementInfo.transport.pos.m_positionY = -6.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 15.4f;
            unit->m_movementInfo.transport.pos.SetOrientation(4.712389f);
            break;
        case 11248: // 5 far back
            unit->m_movementInfo.transport.pos.m_positionX = 2.0f;
            unit->m_movementInfo.transport.pos.m_positionY = 4.0f;
            unit->m_movementInfo.transport.pos.m_positionZ = 15.8f;
            unit->m_movementInfo.transport.pos.SetOrientation(1.570796f);
            break;
        default:
            break;
    ...
    if (_me->IsInWorld())
    {
        ...
        init.MoveTo(unit->m_movementInfo.transport.pos.m_positionX, unit->m_movementInfo.transport.pos.m_positionY, unit->m_movementInfo.transport.pos.m_positionZ);
        init.SetFacing(unit->m_movementInfo.transport.pos.GetOrientation());
