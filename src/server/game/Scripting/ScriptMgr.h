...
class AreaTriggerScript : public ScriptObject
{
    ...
    public:
        ...
        virtual bool OnTrigger(Player* /*p_Player*/, AreaTriggerEntry const* /*p_Trigger*/, bool /*p_Enter*/) { return false; }
};
...
class SpellAreaTriggerScript : public ScriptObject
{
    ...
    public:
        ...
        virtual void OnCreate(AreaTrigger* /*trigger*/) {}

        virtual void OnRemove(AreaTrigger* /*trigger*/, bool /*expired*/) {}

        virtual void OnUpdate(AreaTrigger* /*trigger*/) {}

        virtual bool OnAddTarget(AreaTrigger* /*trigger*/, Unit* /*target*/) { return true; }

        virtual bool OnRemoveTarget(AreaTrigger* /*trigger*/, Unit* /*target*/) { return true; }
};
...
class PlayerScript : public ScriptObject
{
    ...
    public:
        ...
        // Called when a power of player is modify
        virtual void OnModifyPower(Player* /*p_Player*/, Powers /*p_Power*/, int32& /*p_Value*/, SpellInfo const* /*p_SpellInfo = nullptr*/) { }
		...
		virtual void OnUpdateZone(Player* /*p_Player*/, uint32 /*p_NewZone*/, uint32 /*p_OldZone*/, uint32 /*p_NewArea*/, uint32 /*p_OldArea*/) { }
};
...
class ScriptMgr
{
    ...
    public: /* AreaTriggerScript */
        ...
        bool OnAreaTrigger(Player* p_Player, AreaTriggerEntry const* p_Trigger, bool p_Enter);
    
    public: /* SpellAreaTriggerScript */

        void OnSpellAreaTriggerUpdate(AreaTrigger* trigger);
        void OnSpellAreaTriggerCreate(AreaTrigger* trigger);
        void OnSpellAreaTriggerRemove(AreaTrigger* trigger, bool expired);

        bool OnSpellAreaTriggerAddTarget(AreaTrigger* trigger, Unit* target);

        bool OnSpellAreaTriggerRemoveTarget(AreaTrigger* trigger, Unit* target);
    ...
    public: /* PlayerScript */
        ...
        void OnModifyPower(Player* p_Player, Powers p_Power, int32& p_Value, SpellInfo const* p_spellInfo = nullptr);
		...
		void OnPlayerUpdateZone(Player* p_Player, uint32 p_NewZone, uint32 p_OldZone, uint32 p_NewArea, uint32 p_OldArea);
