...
void WorldSession::HandleMessagechatOpcode(WorldPacket& recvData)
{
    ...
    switch (type)
    {
        ...
        case CHAT_MSG_WHISPER:
        {
            ...
            // Player can be out of world while he is at interrealm
            Player* receiver = sObjectAccessor->FindPlayerByNameInOrOutOfWorld(to.c_str());
...
void WorldSession::HandleTextEmoteOpcode(WorldPacket & recvData)
{
    ...
    {
        SendNotification(GetTrinityString(LANG_SPECTATOR_CANT_USE_EMOTE));
        return;
    }
