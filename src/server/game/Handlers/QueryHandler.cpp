...
void WorldSession::SendBroadcastTextDb2Reply(uint32 p_Entry)
{
    ...
    std::string l_Default   = "Greetings, $n";
    std::string l_Text1     = l_Gossip ? l_Gossip->Options[0].Text_0 : l_Default;
    std::string l_Text2     = l_Gossip ? l_Gossip->Options[0].Text_1 : l_Default;
