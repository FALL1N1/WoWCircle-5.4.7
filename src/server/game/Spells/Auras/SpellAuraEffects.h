...
class AuraEffect
{
    ...
    public:
        ...
        void SetTickNumber(uint32 tickNumber) { m_tickNumber = tickNumber; }
    ...
    private:
        ...
        mod_pair GetUniqueVisibleAuraBuff(Unit* target, int8 x);
        bool IsUniqueStackAuraType();
    ...
    public:
        ...
        void HandleAuraModPvPPowerHealing(AuraApplication const* aurApp, uint8 mode, bool apply) const;
        //   fight
        ...
        void HandleAuraModNextSpell(AuraApplication const* aurApp, uint8 mode, bool apply) const;
