...
class AuraScript : public _SpellScript
{
    ...
    #define AURASCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
        ...
        typedef bool(CLASSNAME::*AuraEffectCalcAmountFnType)(AuraEffect const*, int32 &, bool &); \
        typedef void(CLASSNAME::*AuraEffectCalcPeriodicFnType)(AuraEffect const*, bool &, int32 &); \
        typedef void(CLASSNAME::*AuraEffectCalcSpellModFnType)(AuraEffect const*, SpellModifier* &); \
        typedef void(CLASSNAME::*AuraEffectAbsorbHealFnType)(AuraEffect*, int32 &, uint32 &); \
        ...
        class EffectCalcAmountHandler : public EffectBase
        {
            public:
                ...
                bool Call(AuraScript* auraScript, AuraEffect const* aurEff, int32 & amount, bool & canBeRecalculated);
            private:
        ...
        class EffectAbsorbHealHandler : public EffectBase
        {
            public:
                ...
                void Call(AuraScript* auraScript, AuraEffect* aurEff, int32& remainingHeal, uint32 & absorbAmount);
            private:
    ...
    public:
        ...
        // executed when absorb heal aura effect is going to reduce heal
        // example: OnEffectAbsorbHeal += AuraEffectAbsorbHealFn(class::function, EffectIndexSpecifier);
        // where function is: void function (AuraEffect const* aurEff, uint32& absorbAmount);
        ...
        // example: OnEffectAbsorb += AuraEffectAbsorbFn(class::function, EffectIndexSpecifier, EffectName);
