                     ...
                     const char * str, ...)
{
    ...
    std::ostringstream ss;
    ss << "Gm acc id " << gm_account_id << ", gm acc name: " << gm_account_name.c_str() << ", gm char id " << gm_character_id << ", gm char name: " << gm_character_name.c_str()
        << ", player acc id " << sc_account_id << ", player acc name: " << sc_account_name.c_str() << ", player char id " << sc_character_id << ", player char name: " << sc_character_name.c_str()
        << ", command: " << buffer;

    write(new LogMessage(LOG_LEVEL_INFO, LOG_FILTER_GMCOMMAND, ss.str()));
}
